    ...
    <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                @include('formularioAccidentes.formUnoDatosGenerales')
            </div>

            <div class="carousel-item">
                @include('formularioAccidentes.formDosLugarTiempo')
            </div>

            <div class="carousel-item">
                @include('formularioAccidentes.formTresCaracteristicas')
            </div>

            <div class="carousel-item">
                @include('formularioAccidentes.formCuatroDaño')
            </div>

            <div class="carousel-item">
                @include('formularioAccidentes.formCincoCostos')
            </div>

            <div class="carousel-item">
                @include('formularioAccidentes.formSeisAcciones')
            </div>
