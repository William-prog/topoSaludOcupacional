    ...
    <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                @include('formularioIncidentesEdit.formUnoDatosGenerales')
            </div>

            <div class="carousel-item">
                @include('formularioIncidentesEdit.formDosLugarTiempo')
            </div>

            <div class="carousel-item">
                @include('formularioIncidentesEdit.formTresCaracteristicas')
            </div>

            <div class="carousel-item">
                @include('formularioIncidentesEdit.formCuatroDaño')
            </div>

            <div class="carousel-item">
                @include('formularioIncidentesEdit.formCincoCostos')
            </div>

            <div class="carousel-item">
                @include('formularioIncidentesEdit.formSeisAcciones')
            </div>
