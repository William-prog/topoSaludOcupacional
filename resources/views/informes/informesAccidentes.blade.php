    ...
    $(document).ready(function() {
        var table = $('#dataTableAccidentes').DataTable({
            ...
            "language": {
                ...
                "infoEmpty": "No hay Accidentes disponibles",
                "infoFiltered": "(filtrado de _MAX_ Accidentes)",
                "paginate": {
                    "first": "Primero",
                    "last": "Ultimo",
                    "previous": "Anterior",
        ...
        $('#btToggleDisplay').on('click', function() {
            $("#dataTableAccidentes").toggleClass('cards')
            $("#dataTableAccidentes thead").toggle()
        })
    });
</script>

<table id="dataTableAccidentes" class="table table-sm table-hover" cellspacing="0">
    <thead>
        <tr>
    ...
    <tbody id="addRow" class="addRow">
        @foreach($registroAccidente as $registro)
        <tr>
            <td style="width: 5%;">
                {{$registro->id}}
            </td>
