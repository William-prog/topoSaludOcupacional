    ...
    <div class="form-group col">
        <div class="form-group">
            ...
            <select name="form4TipoIncapacidad" id="form4TipoIncapacidad" class="form-control">
                ...
                <option value="Temporal" {{ $registroAccidente->form4TipoIncapacidad == 'Temporal' ? 'selected' : '' }}>Temporal</option>
                <option value="Parcial permanente" {{ $registroAccidente->form4TipoIncapacidad == 'Parcial permanente' ? 'selected' : '' }}>Parcial permanente</option>
                <option value="Total permanente" {{ $registroAccidente->form4TipoIncapacidad == 'Total permanente' ? 'selected' : '' }}>Total permanente</option>
                <option value="Muerte" {{ $registroAccidente->form4TipoIncapacidad == 'Muerte' ? 'selected' : '' }}>Muerte</option>
                <option value="Sin incapacidad" {{ $registroAccidente->form4TipoIncapacidad == 'Sin incapacidad' ? 'selected' : '' }}>Sin incapacidad</option>
                <option value="No especificado" {{ $registroAccidente->form4TipoIncapacidad == 'No especificado' ? 'selected' : '' }}>No especificado</option>
            </select>
        </div>
    </div>
    <div class="form-group col">
...
<div class="row mt-2">
    <div class="form-group col">
        <div class="form-group">
            ...
            <textarea name="form4DiagnosticoInicial" id="form4DiagnosticoInicial" class="form-control" rows="3">{{isset($registroAccidente->form4DiagnosticoInicial)?$registroAccidente->form4DiagnosticoInicial:''}}</textarea>
        </div>
    </div>
</div>
<div class="row mt-2">
    <div class="form-group col">
        <div class="form-group">
            ...
            <textarea name="form4TratamientoInicial" id="form4TratamientoInicial" class="form-control" rows="3">{{isset($registroAccidente->form4TratamientoInicial)?$registroAccidente->form4TratamientoInicial:''}} </textarea>
        </div>
    </div>
</div>
<div class="row mt-2">
    <div class="form-group col">
        <div class="form-group">
            ...
            <textarea name="form4DiagnosticoDependencia" id="form4DiagnosticoDependencia" class="form-control" rows="4">{{isset($registroAccidente->form4DiagnosticoDependencia)?$registroAccidente->form4DiagnosticoDependencia:''}}</textarea>
        </div>
    </div>
    <div class="form-group col">
        <div class="form-group">
            <label for="form4TratamientoDependencia">Tratamiento emitido por la dependencia /Medico: </label>
            <textarea name="form4TratamientoDependencia" id="form4TratamientoDependencia" class="form-control" rows="4">{{isset($registroAccidente->form4TratamientoDependencia)?$registroAccidente->form4TratamientoDependencia:''}}</textarea>
        </div>
    </div>
</div>
<div class="row mt-2">
            ...
            <div class="row mt-2">
                <div class="form-group col">
                    <div class="form-group">
                        ...
                        <textarea name="form4DescripcionAreaAfectada" id="form4DescripcionAreaAfectada" class="form-control" rows="4">{{isset($registroAccidente->form4DescripcionAreaAfectada)?$registroAccidente->form4DescripcionAreaAfectada:''}}</textarea>
                    </div>
                </div>
            </div>
        </div>
