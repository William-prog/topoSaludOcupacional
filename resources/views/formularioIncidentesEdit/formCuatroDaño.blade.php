    ...
    <div class="form-group col">
        <div class="form-group">
            ...
            <select name="form4TipoIncapacidad" id="form4TipoIncapacidad" class="form-control">
                ...
                <option {{ $registroIncidente->form4TipoIncapacidad == 'Temporal' ? 'selected' : '' }} value="Temporal">Temporal</option>
                <option {{ $registroIncidente->form4TipoIncapacidad == 'Parcial permanente' ? 'selected' : '' }} value="Parcial permanente">Parcial permanente</option>
                <option {{ $registroIncidente->form4TipoIncapacidad == 'Total permanente' ? 'selected' : '' }} value="Total permanente">Total permanente</option>
                <option {{ $registroIncidente->form4TipoIncapacidad == 'Muerte' ? 'selected' : '' }} value="Muerte">Muerte</option>
                <option {{ $registroIncidente->form4TipoIncapacidad == 'Sin incapacidad' ? 'selected' : '' }} value="Sin incapacidad">Sin incapacidad</option>
                <option {{ $registroIncidente->form4TipoIncapacidad == 'No especificado' ? 'selected' : '' }} value="No especificado">No especificado</option>
            </select>
        </div>
    </div>
    <div class="form-group col">
...
<div class="row mt-2">
    <div class="form-group col">
        <div class="form-group">
            ...
            <textarea name="form4DiagnosticoInicial" id="form4DiagnosticoInicial" class="form-control" rows="3">{{isset($registroIncidente->form4DiagnosticoInicial)?$registroIncidente->form4DiagnosticoInicial:''}}</textarea>
        </div>
    </div>
</div>
<div class="row mt-2">
    <div class="form-group col">
        <div class="form-group">
            ...
            <textarea name="form4TratamientoInicial" id="form4TratamientoInicial" class="form-control" rows="3">{{isset($registroIncidente->form4TratamientoInicial)?$registroIncidente->form4TratamientoInicial:''}}</textarea>
        </div>
    </div>
</div>
<div class="row mt-2">
    <div class="form-group col">
        <div class="form-group">
            ...
            <textarea name="form4DiagnosticoDependencia" id="form4DiagnosticoDependencia" class="form-control" rows="4">{{isset($registroIncidente->form4DiagnosticoDependencia)?$registroIncidente->form4DiagnosticoDependencia:''}}</textarea>
        </div>
    </div>
    <div class="form-group col">
        <div class="form-group">
            <label for="form4TratamientoDependencia">Tratamiento emitido por la dependencia /Medico: </label>
            <textarea name="form4TratamientoDependencia" id="form4TratamientoDependencia" class="form-control" rows="4">{{isset($registroIncidente->form4TratamientoDependencia)?$registroIncidente->form4TratamientoDependencia:''}}</textarea>
        </div>
    </div>
</div>
<div class="row mt-2">
    <div class="form-group col">
        <div class="form-group">
            ...
            <input name="form4DiasIncapacidad" id="form4DiasIncapacidad" class="form-control" type="number" value="{{isset($registroIncidente->form4DiasIncapacidad)?$registroIncidente->form4DiasIncapacidad:''}}">
        </div>
    </div>
    <div class="form-group col">
        <div class="form-group">
            <label for="form4ImporteCuracion"> Importe estimado de la curación: </label>
            <input name="form4ImporteCuracion" id="form4ImporteCuracion" class="form-control" type="number" value="{{isset($registroIncidente->form4ImporteCuracion)?$registroIncidente->form4ImporteCuracion:''}}">
        </div>
    </div>
</div>
        ...
        <div class="divForm form-group col-8">
            <div class="row mt-2">
                <div class="form-group col-4">
                    <p>
                        <input {{ $registroIncidente->form4AreaCabeza == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaCabeza" name="form4AreaCabeza" onclick="Body('Cabeza')" />
                        <label for="form4AreaCabeza">Cabeza</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaCuello == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaCuello" name="form4AreaCuello" onclick="Body('Cuello')" />
                        <label for="form4AreaCuello">Cuello</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaHombro == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaHombro" name="form4AreaHombro" onclick="Body('Hombro')" />
                        <label for="form4AreaHombro">Hombro</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaBrazoIzquierdo == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaBrazoIzquierdo" name="form4AreaBrazoIzquierdo" onclick="Body('Brazo Izquierdo')" />
                        <label for="form4AreaBrazoIzquierdo">Brazo Izquierdo</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaBrazoDerecho == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaBrazoDerecho" name="form4AreaBrazoDerecho" onclick="Body('Brazo Derecho')" />
                ...
                <div class="form-group col-4">
                    <p>
                        <input {{ $registroIncidente->form4AreaManoIzquierda == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaManoIzquierda" name="form4AreaManoIzquierda" onclick="Body('Mano Izquierda')" />
                        <label for="form4AreaManoIzquierda">Mano Izquierda</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaManoDerecha == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaManoDerecha" name="form4AreaManoDerecha" onclick="Body('Mano Derecha')" />
                        <label for="form4AreaManoDerecha">Mano Derecha</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaPecho == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaPecho" name="form4AreaPecho" onclick="Body('Pecho')" />
                        <label for="form4AreaPecho">Pecho</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaTorax == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaTorax" name="form4AreaTorax" onclick="Body('Costillas')" />
                        <label for="form4AreaTorax">Torax</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaEstomago == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaEstomago" name="form4AreaEstomago" onclick="Body('Estomago')" />
                        <label for="form4AreaEstomago">Estomago</label>
                    </p>
                </div>
                <div class="form-group col-4">
                    <p>
                        <input {{ $registroIncidente->form4AreaGenital == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaGenital" name="form4AreaGenital" onclick="Body('Area Genital')" />
                        <label for="form4AreaGenital">Area Genital</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaPiernaIzquierda == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaPiernaIzquierda" name="form4AreaPiernaIzquierda" onclick="Body('Pierna Izquierdo')" />
                        <label for="form4AreaPiernaIzquierda">Pierna Izquierdo</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaPieIzquierdo == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaPieIzquierdo" name="form4AreaPieIzquierdo" onclick="Body('Pie Izquierdo')" />
                        <label for="form4AreaPieIzquierdo">Pie Izquierdo</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaPieDerecho == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaPieDerecho" name="form4AreaPieDerecho" onclick="Body('Pie Derecho')" />
                        <label for="form4AreaPieDerecho">Pie Derecho</label>
                    </p>
                    <p>
                        <input {{ $registroIncidente->form4AreaPiernaDerecha == 'on' ? 'checked' : '' }} type="checkbox" id="form4AreaPiernaDerecha" name="form4AreaPiernaDerecha" onclick="Body('Pierna Derecha')" />
                        <label for="form4AreaPiernaDerecha">Pierna Derecha</label>
                    </p>
                </div>
                <div class="form-group col-4">
                    <p>
                        <input {{ $registroIncidente->form4SinLesion == 'on' ? 'checked' : '' }} type="checkbox" id="form4SinLesion" name="form4SinLesion" onclick="Body('Sin Lesiones')" />
            ...
            <div class="row mt-2">
                <div class="form-group col">
                    <div class="form-group">
                        ...
                        <textarea name="form4DescripcionAreaAfectada" id="form4DescripcionAreaAfectada" class="form-control" rows="4">{{isset($registroIncidente->form4DescripcionAreaAfectada)?$registroIncidente->form4DescripcionAreaAfectada:''}}</textarea>
                    </div>
                </div>
            </div>
        </div>
